...
class ASTFileParser():
    ...
    def _handle_import(self, node: Node, parent: G, id: str) -> None:
        ...
        #     # check if aliased import
        #     if node.children[3].type == 'aliased_import':
        #         import_name = [
        #             child.children[2].text.decode("utf-8")
        #             for child in node.children if child.type == 'aliased_import'
        #             ]
        #     else:
        #         import_name = [
        #             child.children[0].text.decode("utf-8")
        #             for child in node.children[2:] if child.type == 'dotted_name'
        #             ]
        # elif node.type == 'import_statement':
        #     # check if aliased import
        #     if node.children[1].type == 'aliased_import':
        #         import_name = [
        #             child.children[2].text.decode("utf-8")
        #             for child in node.children if child.type == 'aliased_import'
        #             ]
        ...
        #         import_name = [
        #             child.children[0].text.decode("utf-8")
        #             for child in node.children[1:] if child.type == 'dotted_name'
        #             ]
